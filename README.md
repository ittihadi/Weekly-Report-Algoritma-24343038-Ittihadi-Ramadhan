...
Beberapa tugas yang ada pada modul ini termasuk:

1. **Program mencetak kata dari belakang**, program ini menggunakan pointer
...
Dalam modul ini terdapat beberapa latihan:

1. **Program permainan tebakan**, pada awal proses, program memilih sebuah
